...
Version: 0.2.1
Author: Francis CHRISTANVAL <= C'est lui.
License: GPL2
*/
...
class AppPatPlugin {
    ...
    public function __construct()
    {
        ...
        include_once plugin_dir_path( __FILE__ ).'/class/ManagePat.php';
        ...
        include_once plugin_dir_path( __FILE__ ).'/class/nlp.php';
        include_once plugin_dir_path( __FILE__ ).'/class/AjoutNlp.php';
